...
struct CompositionResult: @unchecked Sendable {
    ...
    let audioTrackMap:    [UUID: CMPersistentTrackID]
}
...
actor CompositionBuilder {
    ...
    nonisolated static func applyPerSegmentVolume(
        track: EditorTrack,
    ...
    nonisolated func buildAudioMixOnly(
        timeline:      EditorTimeline,
        composition:   AVMutableComposition,
...
enum SubtitleFrameBuilder {
    ...
    static func makeCTFont(fontSize: CGFloat, weight: String, fontName: String? = nil) -> CTFont {
    ...
    // v4 (text-style-fidelity-spec §4): shared with SubtitleLayerBuilder.
    static func parseHexColor(_ hex: String) -> CGColor? {
