...
enum ExportEncodingProfile {
    ...
    static func colorProperties(for config: ExportConfig) -> [String: Any] {
    ...
    static func videoOutputSettings(for config: ExportConfig, renderSize: CGSize? = nil) -> [String: Any] {
    ...
    static func audioOutputSettings() -> [String: Any] {
        [
